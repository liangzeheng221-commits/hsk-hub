...
(()=>{
  ...
  const h3={
    1:{focus:'汉字知识：指事字',items:'一、二、上、下、本、末',words:'游客、外地、北门'},2:{focus:'旧字新词',words:'办公楼、外出、午觉'},3:{focus:'旧字新词',words:'鲜奶、冷饮、上面'},4:{focus:'旧字新词',words:'女孩、做客、鲜花'},5:{focus:'汉字知识：会意字',items:'明、休、从、看',words:'听说、有点儿、草地'},6:{focus:'旧字新词',words:'校园、饭桌、花园'},7:{focus:'旧字新词',words:'以后、到时候、迎接'},8:{focus:'旧字新词',words:'面试、自学、离婚'},9:{focus:'汉字知识：形声字（1）',items:'妈、住、放、邻',words:'课间、小路、参赛'},10:{focus:'旧字新词',words:'换季、地面、主菜'},11:{focus:'旧字新词',words:'字典、运动会、开会'},12:{focus:'旧字新词',words:'钱包、电子邮箱、箱子'},13:{focus:'汉字知识：形声字（2）',items:'爸、苹、想、努',words:'红酒、班长、遇见'},14:{focus:'旧字新词',words:'名单、读音、买单'},15:{focus:'旧字新词',words:'电影节、春节、文化节'},16:{focus:'旧字新词',words:'词语、运动鞋、体检'},17:{focus:'汉字知识：形声字（3）',items:'园、病、问、闻',words:'婚假、怎么办、喜爱'},18:{focus:'旧字新词',words:'动物园、人名、自信'},19:{focus:'旧字新词',words:'前年、路过、运动服'},20:{focus:'旧字新词',words:'碗筷、房卡、东北'}
  };
