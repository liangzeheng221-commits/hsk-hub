...
function initGate(){const o=$('#pwOverlay');if(!o)return;if(localStorage.getItem(SITE_UNLOCK_KEY)==='1'||sessionStorage.getItem(SESSION_KEY)==='1'||sessionStorage.getItem('hsk_portal_unlocked')==='1'){sessionStorage.setItem(SESSION_KEY,'1');o.style.display='none';document.body.style.overflow='';}else{document.body.style.overflow='hidden';$('#pwInput')?.addEventListener('keydown',e=>{if(e.key==='Enter')checkPassword()})}}
