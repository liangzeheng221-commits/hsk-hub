...
(()=>{
  if(!document.querySelector('script[data-vocab-unified]')){
    const l=document.createElement('link');l.rel='stylesheet';l.href='../assets/vocab-unified.css?v=20260817-3';l.dataset.vocabUnified='1';document.head.appendChild(l);
    const s=document.createElement('script');s.src='../assets/vocab-unified.js?v=20260817-3';s.dataset.vocabUnified='1';document.body.appendChild(s);
  }
  if(!document.querySelector('script[data-student-polish]')){
    const p=document.createElement('script');p.src='../assets/student-polish.js?v=20260817-3';p.dataset.studentPolish='1';document.body.appendChild(p);
  }
})();
