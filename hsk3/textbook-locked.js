...
(()=>{
  ...
  async function unpack(){
    const b64=[window.__HSK3_LOCKED_B64_1,window.__HSK3_LOCKED_B64_2,window.__HSK3_LOCKED_B64_3,window.__HSK3_LOCKED_B64_4].join('');
    if(!b64||b64.length<60000)throw new Error('[HSK3 locked] packed corpus chunks missing');
  ...
  function apply(corpus,lineCount){
    ...
    delete window.__HSK3_LOCKED_B64_1;delete window.__HSK3_LOCKED_B64_2;delete window.__HSK3_LOCKED_B64_3;delete window.__HSK3_LOCKED_B64_4;
    return contract;
  }
