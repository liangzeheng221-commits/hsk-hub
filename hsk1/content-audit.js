...
(()=>{
  ...
  const posSets={
    ...
    '动词':new Set(['爱','吃','喝','打电话','读','工作','回','叫','开','看','看见','来','买','去','请','请问','认识','睡觉','说','说话','听','喜欢','下雨','写','谢谢','学习','有','没有','住','坐','做','问','出','回来']),
    '专名':new Set(['北京','中国','美国','王方','谢朋','大卫','张']),
    '固定表达':new Set(['对不起','没关系','不客气','再见'])
  };
  const posLabel={
    '代词':'代词 · Đại từ','数词':'数词 · Số từ','量词':'量词 · Lượng từ','方位词':'方位词 · Từ chỉ phương vị','时间词':'时间词 · Từ chỉ thời gian','副词':'副词 · Phó từ','能愿动词':'能愿动词 · Động từ năng nguyện','助词':'助词 · Trợ từ','连词':'连词 · Liên từ','介词':'介词 · Giới từ','叹词':'叹词 · Thán từ','形容词':'形容词 · Tính từ','动词':'动词 · Động từ','专名':'专名 · Tên riêng','固定表达':'固定表达 · Cụm cố định','名词':'名词 · Danh từ'
  };
